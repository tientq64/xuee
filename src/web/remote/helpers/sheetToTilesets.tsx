...
export function sheetToTilesets(sheet: Sheet): Tileset[] {
    ...
    for (const sheetCoord in sheet) {
        const coord = sheetCoord as SheetCoord
        const index: number = sheetCoordToIndexMap[coord]
        const tileset: Tileset = sheet[coord] ?? emptyTileset
