...
declare global {
    /**
     * The possible types of barcode format that can be detected using the Barcode Detection API.
     * This list may change in the future. Adapted from:
    ...
    /**
     * The return type of the Barcode Detect API `detect` function that describes a barcode that has
     * been recognized by the API.
     */
    interface DetectedBarcode {
        /**
         * A DOMRectReadOnly, which returns the dimensions of a rectangle representing the extent of
         * a detected barcode, aligned with the image.
         */
        boundingBox: DOMRectReadOnly
        /**
         * The x and y co-ordinates of the four corner points of the detected barcode relative to
         * the image, starting with the top left and working clockwise. This may not be square due
    ...
    /**
     * The BarcodeDetector interface of the Barcode Detection API allows detection of linear and two
